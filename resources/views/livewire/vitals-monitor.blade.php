<div wire:poll.5s="refreshVitals" class="space-y-4">
 ...
 <span class="text-2xl font-semibold text-white tracking-tighter">{{ $latest->heart_rate ?? '--' }}</span>
 ...
 <div class="flex items-baseline gap-2">
 <span class="text-2xl font-semibold text-white tracking-tighter">{{ $latest->spo2 ?? '--' }}</span>
 ...
 <div class="flex items-baseline gap-2">
 <span class="text-2xl font-semibold text-white tracking-tighter">{{ $latest->temperature ?? '--' }}</span>
 ...
 <div class="flex items-baseline gap-2">
 <span class="text-2xl font-semibold text-white tracking-tighter">{{ $latest->respiratory_rate ?? '--' }}</span>
 <span class="text-[8px] font-semibold text-slate-600 uppercase">BPM</span>
 </div>
 </div>
 </div>
