...
<div class="space-y-8 pb-20">
 ...
 <td class="px-5 py-4">
 <div class="text-[12px] font-semibold text-slate-300 uppercase tracking-tight truncate max-w-xs leading-tight">"{{ $case->procedure_name }}"</div>
 </td>
 ...
 <td class="whitespace-nowrap px-5 py-4">
 <div class="text-[12px] font-semibold text-slate-200 tracking-tight">{{ \Carbon\Carbon::parse($case->scheduled_date)->format('H:i') }}</div>
 <div class="text-[12px] font-semibold text-slate-600 uppercase mt-1 ">{{ \Carbon\Carbon::parse($case->scheduled_date)->format('d M Y') }}</div>
 </td>
 <td class="whitespace-nowrap px-5 py-4 text-center">
 @php
 $statusClasses = [
...
<x-cc-modal id="scheduleModal" title="Authorize Surgical Case" icon="fa-calendar-plus">
 ...
 <div class="pt-4">
 <x-cc-button type="submit" color="indigo" class="w-full font-medium">Authorize Schedule Protocol</x-cc-button>
 </div>
 </form>
</x-cc-modal>
