        ...
        <x-cc-table :headers="['Patient Profile Identity', 'Species Matrix', 'Diagnostic Vector', 'Result Outcome', 'Therapeutic Action', 'Temporal Log']">
            @forelse($cases as $c)
                <tr class="group hover:bg-amber-500/[0.02] transition-colors">
                    ...
                    <td class="whitespace-nowrap px-5 py-4">
                        <div class="text-[11px] font-black text-amber-500 italic tracking-widest uppercase">{{ $c->species }}</div>
                    </td>
                    ...
                    <td class="px-5 py-4">
                        <div class="text-[11px] font-black text-slate-400 uppercase italic tracking-tight line-clamp-1" title="{{ $c->treatment_given }}">{{ $c->treatment_given }}</div>
                    </td>
