...
<x-cc-modal id="procModal" title="Authorize Clinical Dental Procedure" icon="fa-tooth">
 ...
 <div class="pt-4">
 <x-cc-button type="submit" color="indigo" class="w-full font-medium">Authorize Relay Protocol</x-cc-button>
 </div>
 </form>
</x-cc-modal>
...
<x-cc-modal id="chartModal" title="Commit Institutional Tooth Chart Intelligence" icon="fa-map">
 ...
 <div class="pt-4">
 <x-cc-button type="submit" color="sky" class="w-full font-medium">Commit Chart Intelligence</x-cc-button>
 </div>
 </form>
</x-cc-modal>
...
<x-cc-modal id="apptModal" title="Authorize Dental Appointment Protocol" icon="fa-calendar-plus">
 ...
 <div class="pt-4">
 <x-cc-button type="submit" color="emerald" class="w-full font-medium">Authorize Appointment Protocol</x-cc-button>
 </div>
 </form>
</x-cc-modal>
