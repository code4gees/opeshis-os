...
@section('title', 'PAYMENT_RECONCILIATION - Opeshis OS')

<div class="space-y-6 animate-fade-in">
 <div class="flex justify-between items-start border-b border-subtle pb-8">
 <div>
 <h2 class="text-2xl font-semibold uppercase text-white tracking-tight">PAYMENT_RECONCILIATION</h2>
 ...
 <h3 class="text-lg font-semibold text-white uppercase mb-2">PAYMENT_RECONCILIATION Active</h3>
