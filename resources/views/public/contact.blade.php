...
<section class="pub-section">
 ...
 <span style="font-size:.75rem;font-weight:700;color:#6ee7b7;text-transform:uppercase;letter-spacing:.06em;">{{ session('success') }}</span>
 </div>
 @endif

 <form method="POST" action="{{ route('public.contact.submit') }}" style="display:grid;gap:1.25rem;">
 @csrf
 ...
 @error('name')<span style="font-size:.6rem;color:#f87171;font-weight:600;">{{ $message }}</span>@enderror
 </div>
 <div>
 ...
 style="width:100%;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:12px;padding:.8rem 1rem;font-size:.85rem;font-weight:500;color:#fff;font-family:'Inter',sans-serif;outline:none;transition:border-color .2s;"
 onfocus="this.style.borderColor='rgba(99,102,241,.5)'" onblur="this.style.borderColor='rgba(255,255,255,.08)'">
 @error('email')<span style="font-size:.6rem;color:#f87171;font-weight:600;">{{ $message }}</span>@enderror
 </div>
 </div>
 ...
 onfocus="this.style.borderColor='rgba(99,102,241,.5)'" onblur="this.style.borderColor='rgba(255,255,255,.08)'">{{ old('message') }}</textarea>
 @error('message')<span style="font-size:.6rem;color:#f87171;font-weight:600;">{{ $message }}</span>@enderror
 </div>
