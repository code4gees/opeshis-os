...
<div class="py-24 max-w-7xl mx-auto px-6 lg:px-8">
 ...
 <a href="{{ route('public.blog.post', 'crisis-of-his-africa') }}" class="text-[12px] font-semibold font-medium text-sage hover:text-white transition-all flex items-center gap-2">
 Read Deep Dive &rarr;
 </a>
 </article>
