...
<section class="py-24 bg-[#050505]">
 ...
 <a href="{{ route('login') }}" class="inline-flex items-center text-sage font-semibold text-[12px] font-medium group-hover:text-white transition-all">
 Access Module &rarr;
 </a>
 </div>
 ...
 <a href="{{ route('login') }}" class="inline-flex items-center text-emerald-500 font-semibold text-[12px] font-medium group-hover:text-white transition-all">
 Access Module &rarr;
 </a>
 </div>
 ...
 <a href="{{ route('login') }}" class="inline-flex items-center text-purple-500 font-semibold text-[12px] font-medium group-hover:text-white transition-all">
 Access Module &rarr;
 </a>
 </div>
