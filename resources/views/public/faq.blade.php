...
<section class="py-24 bg-[#050505]">
 ...
 <a href="{{ route('public.contact') }}" class="px-12 py-6 bg-sage rounded-2xl font-semibold uppercase text-[12px] tracking-wider hover:bg-sage transition /30">Request Live Demo</a>
 <a href="{{ route('public.features') }}" class="px-12 py-6 bg-[#2a2e38] border border-subtle rounded-2xl font-semibold uppercase text-[12px] tracking-wider hover:bg-white/10 transition">Technical Briefing</a>
 </div>
 </div>
 </div>
 </div>
