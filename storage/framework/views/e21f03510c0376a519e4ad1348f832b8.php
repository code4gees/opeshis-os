...
<div class="space-y-8 animate-fade-in pb-20">
 ...
 <h2 class="text-5xl font-semibold text-white tracking-tighter"><?php echo e($stats->pending ?? 0); ?></h2>
 ...
 <div class="flex items-end gap-3">
 <h2 class="text-5xl font-semibold text-emerald-500 tracking-tighter"><?php echo e($stats->sent_today ?? 0); ?></h2>
 ...
 <div class="flex items-end gap-3">
 <h2 class="text-5xl font-semibold text-rose-500 tracking-tighter"><?php echo e($stats->failed_today ?? 0); ?></h2>
 ...
 <td class="px-6 py-6">
 <div class="font-semibold text-white text-sm uppercase group-hover:text-sage transition-colors"><?php echo e($m->recipient_name ?: 'ANONYMOUS_RECIPIENT'); ?></div>
 <div class="text-[12px] font-bold text-slate-500 font-medium mt-1 "><?php echo e($m->recipient_phone); ?></div>
 </td>
 <td class="px-6 py-6">
 <span class="px-3 py-1 bg-sage/10 text-sage border border-indigo-500/20 rounded-lg text-[8px] font-semibold font-medium"><?php echo e($m->channel); ?></span>
 </td>
 <td class="px-6 py-6">
 <div class="text-[12px] text-slate-400 max-w-sm truncate group-hover:whitespace-normal transition-all leading-relaxed uppercase tracking-tight">"<?php echo e($m->resolved_message); ?>"</div>
 <div class="text-[7px] font-semibold text-slate-600 uppercase mt-2 tracking-wider">RELAY_SOURCE: <?php echo e($m->provider ?? 'INSTITUTIONAL_CORE'); ?></div>
 </td>
 ...
 ?>
 <span class="px-4 py-1.5 rounded-xl text-[8px] font-semibold font-medium border <?php echo e($statusCls); ?> /5">
 <?php echo e($m->status); ?>
