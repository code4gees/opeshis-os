...
<!-- PUBLIC NAVBAR -->
<nav class="pub-nav">
    <a href="<?php echo e(route('public.landing')); ?>" class="pub-nav-brand">
    ...
    <div class="pub-nav-links">
        <a href="<?php echo e(route('public.features')); ?>" class="pub-nav-link <?php echo e(request()->routeIs('public.features') ? 'active' : ''); ?>">Features</a>
        <a href="<?php echo e(route('public.about')); ?>" class="pub-nav-link <?php echo e(request()->routeIs('public.about') ? 'active' : ''); ?>">About</a>
        <a href="<?php echo e(route('public.faq')); ?>" class="pub-nav-link <?php echo e(request()->routeIs('public.faq') ? 'active' : ''); ?>">FAQ</a>
        <a href="<?php echo e(route('public.blog')); ?>" class="pub-nav-link <?php echo e(request()->routeIs('public.blog') ? 'active' : ''); ?>">Blog</a>
        <a href="<?php echo e(route('public.contact')); ?>" class="pub-nav-link <?php echo e(request()->routeIs('public.contact') ? 'active' : ''); ?>">Contact</a>
        <a href="<?php echo e(route('login')); ?>" class="pub-nav-cta">Enter Portal →</a>
    </div>
</nav>
...
<footer class="pub-footer">
    ...
    <div class="pub-footer-links">
        <a href="<?php echo e(route('public.about')); ?>" class="pub-footer-link">About</a>
        <a href="<?php echo e(route('public.features')); ?>" class="pub-footer-link">Features</a>
        <a href="<?php echo e(route('public.faq')); ?>" class="pub-footer-link">FAQ</a>
        <a href="<?php echo e(route('public.blog')); ?>" class="pub-footer-link">Blog</a>
        <a href="<?php echo e(route('public.contact')); ?>" class="pub-footer-link">Contact</a>
        <a href="<?php echo e(route('login')); ?>" class="pub-footer-link">Portal Login</a>
    </div>
...
<?php /**PATH C:\laragon\www\opeshis\resources\views\components\public-shell.blade.php ENDPATH**/ ?>