<aside class="w-[260px] bg-surface-base flex flex-col h-screen sticky top-0 shrink-0 border-r border-white/[0.02]">
 ...
 <nav class="flex-1 px-4 py-2 flex flex-col gap-2">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasPermission('module_admin')): ?>
        ...
        <?php echo $nav(route('admin.intelligence.analytics'), 'Analytics Hub', 'fa-chart-mixed', 'analytics*'); ?>

        <?php echo $nav(route('admin.intelligence.reporting'), 'Reporting Command', 'fa-file-chart-column', 'reporting*'); ?>
...
<?php /**PATH /app/resources/views/partials/sidebar.blade.php ENDPATH**/ ?>