                ...
                <tr class="group hover:bg-amber-500/[0.02] transition-colors">
                    <td class="whitespace-nowrap px-5 py-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <div class="text-sm font-bold text-slate-200 uppercase tracking-tight group-hover:text-amber-400 transition-colors italic"><?php echo e($w->patient->full_name); ?></div>
                                <div class="text-[10px] font-black text-slate-500 uppercase tracking-widest"><?php echo e($w->patient->medical_id); ?></div>
                            </div>
                        </div>
                    </td>
                    <td class="px-5 py-4">
                        <div class="text-xs font-black text-slate-200 uppercase tracking-tight"><?php echo e($w->wound_type); ?></div>
                        <div class="text-[8px] font-black text-slate-500 uppercase tracking-widest mt-1">Stage: <?php echo e($w->stage); ?> · Size: <?php echo e($w->size_cm); ?>cm</div>
                    </td>
                    <td class="whitespace-nowrap px-5 py-4">
                    ...
                    <td class="px-5 py-4">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($latest): ?>
                            <div class="text-[10px] font-black text-slate-300 uppercase italic line-clamp-1">"<?php echo e($latest->wound_bed); ?>"</div>
                            <div class="text-[8px] font-bold text-slate-500 uppercase tracking-widest mt-1">Synced: <?php echo e(\Carbon\Carbon::parse($latest->created_at)->diffForHumans()); ?></div>
                        <?php else: ?>
