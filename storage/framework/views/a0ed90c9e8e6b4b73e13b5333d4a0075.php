...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
 ...
 <td class="whitespace-nowrap px-5 py-4">
 <div class="text-[12px] font-semibold text-amber-500 tracking-wider uppercase"><?php echo e($c->species); ?></div>
 </td>
 ...
 <td class="px-5 py-4">
 <div class="text-[12px] font-semibold text-slate-400 uppercase tracking-tight line-clamp-1" title="<?php echo e($c->treatment_given); ?>"><?php echo e($c->treatment_given); ?></div>
 </td>
