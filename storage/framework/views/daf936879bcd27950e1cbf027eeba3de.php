...
<div class="space-y-8 animate-fade-in">
    ...
    <div class="glass-panel rounded-[3rem] border border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.12)] overflow-hidden">
        <div class="px-10 py-8 border-b border-white/5 bg-white/5 flex justify-between items-center">
            ...
            <span class="px-3 py-1 bg-white/5 text-slate-400 rounded-lg text-[8px] font-black uppercase tracking-widest border border-white/10 italic">Daily Sync: <?php echo e(now()->format('d M Y')); ?></span>
        </div>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-white/5">
                    ...
                    <tr class="hover:bg-white/5 transition-all group">
                        <td class="px-10 py-6">
                            <div class="font-black text-white text-sm uppercase group-hover:text-emerald-400 transition-colors"><?php echo e($p->full_name); ?></div>
                            <div class="text-[9px] font-bold text-slate-500 uppercase tracking-widest mt-0.5"><?php echo e($p->medical_id); ?></div>
                        </td>
                        <td class="px-6 py-6">
                            <span class="px-3 py-1 bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 rounded-lg text-[8px] font-black uppercase tracking-widest"><?php echo e($p->meal_type); ?></span>
                        </td>
                        <td class="px-6 py-6">
                            <div class="text-[10px] text-slate-400 italic max-w-xs truncate group-hover:whitespace-normal group-hover:overflow-visible transition-all">"<?php echo e($p->restrictions ?: 'No documented clinical restrictions'); ?>"</div>
                        </td>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['Breakfast', 'Lunch', 'Dinner']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            <td class="px-6 py-6 text-center">
                                ...
                                <?php else: ?>
                                    <button onclick="logMealDelivery('<?php echo e($p->id); ?>', '<?php echo e($meal); ?>')" class="w-10 h-10 bg-white/5 text-slate-500 rounded-xl flex items-center justify-center mx-auto hover:bg-indigo-500/20 hover:text-indigo-400 transition-all border border-white/10 hover:border-indigo-500/30">
