    ...
    <div class="flex justify-between items-center mb-8 border-b border-white/10 pb-8">
        ...
        <div class="flex items-center gap-8">
            <div class="text-right">
                ...
                <span class="text-2xl font-black text-rose-600"><?php echo e($maintenanceAlerts); ?> Assets</span>
            </div>
        </div>
    </div>
            ...
            <tbody class="divide-y divide-slate-50">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <tr class="hover:bg-slate-50/50 transition">
                        <td class="px-10 py-6">
                            <div class="text-sm font-black text-white"><?php echo e($a->name); ?></div>
                            <div class="text-[10px] text-slate-400 font-mono uppercase mt-1">S/N: <?php echo e($a->serial_number); ?></div>
                        </td>
                        <td class="text-[10px] font-black text-indigo-600 uppercase"><?php echo e($a->category); ?></td>
                        <td class="text-[11px] font-mono text-slate-400"><?php echo e($a->purchase_date ?: '—'); ?></td>
                        <td class="text-[11px] font-mono text-slate-400"><?php echo e($a->last_maintenance_date ?: '—'); ?></td>
                        <td class="text-[11px] font-black <?php echo e($isDue ? 'text-rose-500 animate-pulse' : 'text-white'); ?>">
                        ...
                        <td class="px-10 py-6 text-right">
                            ...
                            <?php else: ?>
                                <span class="px-3 py-1 bg-emerald-50 text-emerald-600 rounded-lg text-[9px] font-black uppercase"><?php echo e($a->status); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                    </tr>
