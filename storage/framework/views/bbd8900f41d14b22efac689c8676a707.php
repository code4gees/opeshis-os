...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
 ...
 <td class="whitespace-nowrap px-5 py-4">
 <div class="text-[12px] font-semibold text-slate-400 uppercase tracking-tight truncate max-w-xs leading-relaxed">"<?php echo e($c->admitting_diagnosis); ?>"</div>
 ...
 <div class="text-[12px] font-semibold text-slate-200"><?php echo e($v->bp_systolic); ?>/<?php echo e($v->bp_diastolic); ?></div>
 <div class="text-[8px] font-bold text-slate-600 font-medium">BP</div>
 </div>
 <div class="text-center">
 <div class="text-[12px] font-semibold <?php echo e($v->spo2 < 90 ? 'text-rose-500 animate-pulse' : 'text-emerald-500'); ?>">
 <?php echo e($v->spo2); ?>%
 </div>
...
<?php unset($__componentOriginal2d350f6afc4d732ce961fba75ba7e203); ?>
<?php endif; ?>
 <form method="POST" action="<?php echo e(route('specialty.critical.hdu.escalate', $c->id)); ?>" class="inline-block">
 <?php echo csrf_field(); ?>
 <?php if (isset($component)) { $__componentOriginal2d350f6afc4d732ce961fba75ba7e203 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2d350f6afc4d732ce961fba75ba7e203 = $attributes; } ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
 ...
 <form method="POST" action="<?php echo e(route('specialty.critical.hdu.admit')); ?>" class="space-y-6">
 <?php echo csrf_field(); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
 ...
 <form method="POST" action="<?php echo e(route('specialty.critical.hdu.vitals')); ?>" class="space-y-6">
 <?php echo csrf_field(); ?>
 ...
 <input name="<?php echo e($name); ?>" type="number" step="0.1" class="w-full bg-card/50 border border-subtle rounded-xl px-4 py-2.5 text-xs font-semibold text-slate-200 outline-none focus:ring-2 focus:ring-amber-600">
 </div>
...
function openDischargeModal(id) {
  let url = "<?php echo e(route('specialty.critical.hdu.discharge', ':id')); ?>";
