...
<div class="space-y-8 animate-fade-in pb-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        ...
        <div class="glass-panel rounded-[2.5rem] border border-white/10 shadow-xl p-10 relative overflow-hidden group bg-white/[0.02]">
            ...
            <p class="text-[9px] font-black text-slate-500 uppercase tracking-[0.2em] mb-4 italic"><?php echo e($label); ?></p>
            <p class="text-5xl font-black text-<?php echo e($color === 'indigo' ? 'indigo-400' : ($color === 'amber' ? 'amber-500' : 'emerald-500')); ?> italic tracking-tighter leading-none"><?php echo e($val); ?></p>
            <p class="text-[10px] font-black text-slate-600 mt-6 uppercase tracking-widest italic">Target Matrix: 95% <?php echo e($sub); ?></p>
        </div>
    ...
    <div class="glass-panel rounded-[3rem] border border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.12)] overflow-hidden bg-white/[0.02]">
        <div class="px-10 py-8 border-b border-white/5 bg-white/5 flex items-center justify-between">
            ...
            <div class="flex gap-4">
                <span class="px-4 py-1.5 bg-white/5 border border-white/10 text-slate-500 rounded-xl text-[9px] font-black uppercase italic"><?php echo e($metrics['counts']['on_art']); ?> ACTIVE_ON_ART</span>
            </div>
        </div>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-white/5">
                    ...
                    <tr class="hover:bg-white/5 transition-all group">
                        <td class="px-10 py-6">
                            <div class="font-black text-white text-base uppercase group-hover:text-indigo-400 transition-colors"><?php echo e($e->full_name); ?></div>
                            <div class="text-[9px] font-bold text-slate-500 uppercase tracking-[0.2em] mt-1 italic">AGE: <?php echo e($e->age); ?> · <?php echo e(strtoupper($e->gender)); ?></div>
                        </td>
                        <td class="py-6 font-mono text-[11px] font-black text-indigo-400 tracking-widest"><?php echo e($e->art_number); ?></td>
                        <td class="py-6">
                            <span class="px-3 py-1 bg-white/5 border border-white/10 rounded-lg text-[9px] font-black text-slate-400 uppercase italic"><?php echo e($e->current_regimen ?: 'TREATMENT_PENDING'); ?></span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($e->regimen_line): ?>
                                <div class="text-[8px] font-black text-slate-600 mt-2 uppercase tracking-widest italic"><?php echo e($e->regimen_line); ?> LINE_PROTOCOL</div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td class="py-6 text-[11px] font-black text-slate-500 uppercase italic">Stage <?php echo e($e->who_stage); ?></td>
                        <td class="py-6">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($e->last_vl !== null): ?>
                                <div class="text-sm font-black <?php echo e($e->last_vl >= 1000 ? 'text-rose-500 animate-pulse' : 'text-emerald-500'); ?> italic tracking-tighter">
                                    <?php echo e(number_format($e->last_vl)); ?> COPIES/ML
                                </div>
                                <div class="text-[8px] font-black text-slate-600 uppercase mt-1 italic"><?php echo e(date('d M Y', strtotime($e->last_vl_date))); ?></div>
                            <?php else: ?>
                        ...
                        <td class="px-10 py-6 text-right">
                            <div class="flex justify-end gap-4 opacity-0 group-hover:opacity-100 transition-all">
                                <button onclick="openVisitModal('<?php echo e($e->id); ?>')" class="px-4 py-1.5 bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 rounded-lg text-[8px] font-black uppercase tracking-widest italic hover:bg-indigo-600 hover:text-white transition-all">Visit</button>
                                <button onclick="openRegimenModal('<?php echo e($e->id); ?>', '<?php echo e($e->current_regimen); ?>')" class="px-4 py-1.5 bg-amber-500/10 text-amber-500 border border-amber-500/20 rounded-lg text-[8px] font-black uppercase tracking-widest italic hover:bg-amber-600 hover:text-white transition-all">Regimen</button>
                            </div>
                        </td>
                    </tr>
