...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr class="group hover:bg-indigo-500/[0.02] transition-colors border-b border-white/5 last:border-0">
                    <td class="px-6 py-4">
                        <div class="font-black text-white uppercase text-xs group-hover:text-indigo-400 transition-colors"><?php echo e($p->patient->full_name); ?></div>
                        <div class="text-[10px] text-slate-500 mt-1 uppercase"><?php echo e($p->patient->medical_id); ?></div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="text-[11px] font-black text-indigo-400 uppercase tracking-tight italic"><?php echo e($p->cancer_type); ?></div>
                        <div class="text-[8px] font-bold text-slate-600 uppercase tracking-widest mt-1">ICD: <?php echo e($p->icd_code); ?></div>
                    </td>
                    <td class="px-6 py-4">
...
<?php endif; ?>
                        <div class="text-[8px] font-black text-rose-500 uppercase mt-1 tracking-widest">Stage <?php echo e(strtoupper($p->stage)); ?></div>
                        <div class="text-[8px] font-bold text-slate-600 uppercase tracking-widest mt-1 italic">Hist: <?php echo e($p->histology); ?></div>
                    </td>
                    <td class="px-6 py-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($p->activePlan): ?>
                            <div class="text-[10px] font-black text-slate-200 uppercase italic tracking-tight"><?php echo e($p->activePlan->protocol->name ?? 'CUSTOM_REGIMEN'); ?></div>
                            <div class="text-[8px] font-black text-slate-600 uppercase tracking-widest mt-1 italic">Intent: <?php echo e(strtoupper($p->activePlan->intent)); ?></div>
                        <?php else: ?>
