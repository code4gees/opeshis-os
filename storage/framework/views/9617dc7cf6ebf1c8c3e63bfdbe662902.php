...
<div class="space-y-6 animate-fade-in">
    ...
    <div class="glass-panel rounded-[2.5rem] border border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.12)] overflow-hidden">
        <div class="px-10 py-6 border-b border-white/5 bg-slate-50/30"><h3 class="text-xs font-black text-white uppercase tracking-widest">Enrolled Patients — <?php echo e($enrollments->count()); ?> records</h3></div>
        <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-slate-50">
                ...
                <tr class="hover:bg-slate-50/50 transition">
                    <td class="px-10 py-5"><div class="text-sm font-black text-white"><?php echo e($e->full_name); ?></div><div class="text-[10px] text-slate-400 font-bold"><?php echo e($e->medical_id); ?></div></td>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($enrollments->isEmpty()): ?><tr><td colspan="4" class="p-20 text-center text-slate-300 italic">No biometric enrollments.</td></tr><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </tbody>
        </table>
    </div>
</div>
