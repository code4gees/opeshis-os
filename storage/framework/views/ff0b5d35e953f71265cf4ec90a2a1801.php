...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr class="group hover:bg-sky-500/[0.02] transition-colors border-b border-white/5 last:border-0">
                    <td class="px-6 py-4">
                        <div class="font-black text-white uppercase text-xs group-hover:text-sky-400 transition-colors italic"><?php echo e($s->patient->full_name); ?></div>
                        <div class="text-[10px] text-slate-500 mt-1 uppercase"><?php echo e($s->patient->medical_id); ?></div>
                    </td>
                    <td class="px-6 py-4">
                        <p class="text-[11px] font-black text-slate-400 leading-relaxed uppercase tracking-tight line-clamp-2">"<?php echo e($s->indication); ?>"</p>
                    </td>
                    <td class="px-6 py-4">
...
<?php endif; ?>
                                <div class="text-[10px] font-black text-white italic leading-none"><?php echo e($s->measurement->fev1_fvc_ratio); ?>% <span class="text-[8px] text-slate-500 ml-1">FEV1/FVC</span></div>
                            </div>
                        <?php else: ?>
                            <?php if (isset($component)) { $__componentOriginal8c81617a70e11bcf247c4db924ab1b62 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8c81617a70e11bcf247c4db924ab1b62 = $attributes; } ?>
