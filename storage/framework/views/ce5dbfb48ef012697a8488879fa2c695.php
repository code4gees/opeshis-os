...
<div class="space-y-8 animate-fade-in pb-20">
 ...
 <div>
 <h1 class="text-2xl font-semibold text-slate-200 uppercase tracking-tighter">Incident Command Hub</h1>
 <p class="text-xs font-bold text-slate-500 font-medium mt-1">Quality Assurance · Adverse Event Matrix · Root Cause Intelligence</p>
 </div>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
 ...
 <div class="text-sm font-bold text-slate-200 uppercase tracking-tight group-hover:text-rose-400 transition-colors "><?php echo e($i->incident_type); ?></div>
 <div class="text-[12px] font-semibold text-slate-500 font-medium mt-1 truncate max-w-[200px]"><?php echo e($i->description); ?></div>
 </td>
 <td class="whitespace-nowrap px-5 py-4 text-[12px] font-semibold text-slate-400 font-medium ">
 ...
 'critical' => 'bg-rose-500/10 text-rose-500 border-rose-500/20 /10 animate-pulse',
 'high' => 'bg-amber-500/10 text-amber-500 border-amber-500/20',
 'medium' => 'bg-sage/10 text-sage border-indigo-500/20',
 default => 'bg-slate-500/10 text-slate-500 border-slate-500/20',
 };
 ?>
 <span class="px-3 py-1.5 rounded-lg border <?php echo e($sevCls); ?> text-[8px] font-semibold font-medium ">
 <?php echo e(strtoupper($i->severity)); ?>

 </span>
 </td>
 <td class="whitespace-nowrap px-5 py-4">
 <span class="px-3 py-1.5 bg-card/50 text-slate-500 border border-subtle rounded-lg text-[8px] font-semibold font-medium ">
 <?php echo e(strtoupper($i->status)); ?>

 </span>
 </td>
 <td class="whitespace-nowrap px-5 py-4">
 <div class="text-[12px] font-semibold text-slate-300 uppercase tracking-tight "><?php echo e($i->reporter->name ?? 'SYSTEM_USER'); ?></div>
 <div class="text-[12px] font-semibold text-slate-600 font-medium"><?php echo e($i->reporter->staff_code ?? 'INSTITUTIONAL'); ?></div>
 </td>
 ...
 <tr>
 <td colspan="6" class="px-6 py-12 text-center text-slate-600 text-sm">No institutional incidents identified in the quality surveillance matrix.</td>
 </tr>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
 ...
 <?php echo csrf_field(); ?>
 <div>
 <label class="block text-[12px] font-semibold text-slate-500 font-medium mb-2 ">Institutional Incident Type</label>
 ...
 <div>
 <label class="block text-[12px] font-semibold text-slate-500 font-medium mb-2 ">Temporal Node (Date)</label>
 <input name="incident_date" type="date" required class="w-full bg-card/50 border border-subtle rounded-xl px-4 py-3 text-sm font-bold text-slate-200 outline-none focus:ring-2 focus:ring-rose-600">
 </div>
 <div>
 <label class="block text-[12px] font-semibold text-slate-500 font-medium mb-2 ">Location Node</label>
 <input name="location" required placeholder="e.g. PHARMACY_ALPHA" class="w-full bg-card/50 border border-subtle rounded-xl px-4 py-3 text-sm font-bold text-slate-200 outline-none focus:ring-2 focus:ring-rose-600 uppercase">
 </div>
 </div>
 <div>
 <label class="block text-[12px] font-semibold text-slate-500 font-medium mb-2 ">Incident Intelligence Narrative</label>
 <textarea name="description" rows="3" required placeholder="ENTER_INCIDENT_NARRATIVE..." class="w-full bg-card/50 border border-subtle rounded-xl px-4 py-3 text-sm font-bold text-slate-200 outline-none focus:ring-2 focus:ring-rose-600 uppercase resize-none no-scrollbar"></textarea>
 </div>
 <div>
 <label class="block text-[12px] font-semibold text-slate-500 font-medium mb-2 ">Immediate Containment Action</label>
 <textarea name="immediate_action" rows="2" required placeholder="ENTER_CONTAINMENT_PROTOCOL..." class="w-full bg-card/50 border border-subtle rounded-xl px-4 py-3 text-sm font-bold text-slate-200 outline-none focus:ring-2 focus:ring-rose-600 uppercase resize-none no-scrollbar"></textarea>
 </div>
 <div>
 <label class="block text-[12px] font-semibold text-slate-500 font-medium mb-2 ">Severity Matrix Assignment</label>
 <select name="severity" class="w-full bg-card/50 border border-subtle rounded-xl px-4 py-3 text-sm font-bold text-slate-200 outline-none focus:ring-2 focus:ring-rose-600">
...
<?php /**PATH /app/resources/views/ops/incidents.blade.php ENDPATH**/ ?>