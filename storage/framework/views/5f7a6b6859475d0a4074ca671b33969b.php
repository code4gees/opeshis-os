        ...
        <div class="mt-4 md:mt-0 flex items-center gap-4">
            <div class="flex items-center gap-6 px-6 py-2.5 bg-slate-900/40 rounded-lg border border-slate-700/60">
                <div class="text-center">
                    ...
                    <p class="text-lg font-bold text-slate-100 leading-none"><?php echo e($registry->count()); ?></p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1 bg-slate-800 p-8 rounded-xl border border-slate-700/60 shadow-sm relative overflow-hidden flex flex-col justify-center">
            ...
            <div class="w-full bg-slate-900 h-2 rounded-full overflow-hidden mb-4">
                <div class="bg-blue-500 h-full rounded-full" style="width: <?php echo e($nicuRate); ?>%"></div>
            </div>
            <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Current Load: <?php echo e(round($nicuRate)); ?>%</p>
        </div>
                                ...
                                <td class="px-8 py-6">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-0.5"><?php echo e($r->medical_id); ?> • <?php echo e($r->gender); ?></div>
                                        </div>
                                    </div>
                                </td>
