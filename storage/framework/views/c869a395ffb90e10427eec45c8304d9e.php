...
<div class="max-w-[1600px] mx-auto pb-10">
 ...
 <div class="flex items-baseline gap-2 mt-1 relative z-10">
 <span class="text-2xl font-bold text-white"><?php echo e($stats['kiosk_vitals_today']); ?></span>
 ...
 <div class="flex items-baseline gap-2 mt-1 relative z-10">
 <span class="text-2xl font-bold text-white">$<?php echo e(number_format($stats['revenue_today'])); ?></span>
 </div>
 <?php else: ?>
 ...
 <a href="<?php echo e(route('patients.index')); ?>" class="px-3 py-1 rounded bg-[#2a2e38] text-xs text-slate-300 hover:text-white border border-subtle flex items-center gap-1.5 transition-colors">
 ...
 <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $active_queue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
 <tr onclick="window.location.href='<?php echo e(route('emr.main')); ?>'" class="<?php echo e($loop->even ? 'bg-[#1a1d24]/30' : 'bg-transparent'); ?> hover:bg-[#2a2e38] transition-colors group cursor-pointer">
 <td class="px-5 py-3 text-[12px] text-slate-200 font-medium"><?php echo e($q->patient->full_name); ?></td>
 <td class="px-5 py-3">
 ...
 <td class="px-5 py-3 text-[12px] text-slate-300"><?php echo e($q->created_at->diffForHumans(null, true)); ?></td>
 <td class="px-5 py-3 text-[12px] text-slate-300"><?php echo e($q->doctor->name ?? 'Unassigned'); ?></td>
 </tr>
 ...
 <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [ [40,25],[70,35],[100,60],[40,30],[50,80],[90,40],[40,60],[80,45],[30,90] ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bars): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
 <div class="flex gap-0.5 items-end h-full w-full justify-center">
 <div class="w-2 bg-[#5d8b76] rounded-t-sm" style="height: <?php echo e($bars[0]); ?>%"></div>
 <div class="w-2 bg-[#82c09a] rounded-t-sm" style="height: <?php echo e($bars[1]); ?>%"></div>
 </div>
...
<script>
 ...
 x: { border: {display: true, color: 'rgba(255,255,255,0.06)'}, grid: { display: false }, ticks: { font: {size: 9} } }
  ...
  <a href="<?php echo e(route('clinical.emergency.index')); ?>" class="bg-card/50 border border-subtle hover:border-rose-500/50 p-6 rounded-2xl flex flex-col items-center justify-center gap-3 group transition-all shadow-lg hover:shadow-rose-500/5">
  ...
  <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasPermission('module_clinical')): ?>
  <a href="<?php echo e(route('specialty.critical.icu.index')); ?>" class="bg-card/50 border border-subtle hover:border-blue-500/50 p-6 rounded-2xl flex flex-col items-center justify-center gap-3 group transition-all shadow-lg hover:shadow-blue-500/5">
  ...
  <a href="<?php echo e(route('operations.diagnostics.pharmacy')); ?>" class="bg-card/50 border border-subtle hover:border-emerald-500/50 p-6 rounded-2xl flex flex-col items-center justify-center gap-3 group transition-all shadow-lg hover:shadow-emerald-500/5">
  ...
  <a href="<?php echo e(route('operations.diagnostics.lab')); ?>" class="bg-card/50 border border-subtle hover:border-amber-500/50 p-6 rounded-2xl flex flex-col items-center justify-center gap-3 group transition-all shadow-lg hover:shadow-amber-500/5">
  ...
  <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasPermission('module_clinical')): ?>
  <a href="<?php echo e(route('specialty.clinics.dental.index')); ?>" class="bg-card/50 border border-subtle hover:border-white/30 p-6 rounded-2xl flex flex-col items-center justify-center gap-3 group transition-all shadow-lg hover:shadow-white/5">
  ...
  <a href="<?php echo e(route('specialty.clinics.eye.index')); ?>" class="bg-card/50 border border-subtle hover:border-indigo-500/50 p-6 rounded-2xl flex flex-col items-center justify-center gap-3 group transition-all shadow-lg hover:shadow-indigo-500/5">
