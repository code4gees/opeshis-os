...
<?php $__env->startSection('title', 'TERMS - Opeshis OS'); ?>

<div class="py-24 glass-panel">
    <div class="max-w-4xl mx-auto px-8">
        <h1 class="text-5xl font-black text-white mb-12 uppercase tracking-tighter">TERMS</h1>
        <div class="prose prose-slate max-w-none font-medium text-slate-300 leading-relaxed space-y-8">
            <p class="text-xl">Opeshis OS is committed to the highest standards of institutional integrity. This TERMS page outlines our framework for universal healthcare delivery.</p>
            <section>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\opeshis\resources\views\public\terms.blade.php ENDPATH**/ ?>