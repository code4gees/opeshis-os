...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $register; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr class="group hover:bg-rose-500/[0.02] transition-colors border-b border-white/5 last:border-0">
                    <td class="px-6 py-4">
                        <div class="text-sm font-bold text-slate-200 uppercase tracking-tight group-hover:text-rose-400 transition-colors italic"><?php echo e($n->item_name); ?></div>
                        <div class="text-[10px] font-black text-slate-500 uppercase tracking-widest mt-1">S_ID: <?php echo e(substr($n->id, 0, 8)); ?></div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="text-xs font-black text-slate-300 uppercase italic"><?php echo e($n->strength ?: 'STANDARD_PROTOCOL'); ?></div>
                    ...
                    <td class="px-6 py-4">
                        <div class="text-sm font-black text-white italic leading-none"><?php echo e($n->current_balance); ?> <span class="text-[9px] text-slate-500 ml-1 uppercase">Units</span></div>
                        <div class="text-[8px] font-bold text-slate-600 uppercase tracking-widest mt-1">Verified stock node</div>
                    </td>
                    <td class="px-6 py-4 text-right">
                        <div class="text-[10px] font-black text-slate-400 uppercase tracking-widest italic"><?php echo e(\Carbon\Carbon::parse($n->updated_at)->format('d M, H:i')); ?></div>
...
<?php endif; ?>
                    ...
                    <td class="px-6 py-4 text-center">
                        <span class="<?php echo e($m->movement_type === 'IN' ? 'text-emerald-500' : 'text-rose-500'); ?> font-black text-sm italic">
                            <?php echo e($m->movement_type === 'IN' ? '+' : '-'); ?><?php echo e($m->quantity); ?>

                        </span>
                    </td>
                    <td class="px-6 py-4 text-center text-white font-black italic"><?php echo e($m->balance_after); ?></td>
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="text-[9px] font-black text-slate-300 uppercase tracking-widest italic">W: <?php echo e($m->witnessed_by); ?></div>
