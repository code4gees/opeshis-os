...
<?php $__env->startSection('title', 'Platform Pillars — Unified Healthcare Ecosystem | Opeshis OS'); ?>
...
<div class="pt-32 pb-20 border-b border-white/5 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
        <h1 class="text-4xl md:text-6xl font-black text-white mb-6 uppercase tracking-tighter fade-up">Platform Ecosystem</h1>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div class="feature-card rounded-[3rem] p-10 group fade-up">
                <div class="w-14 h-14 bg-indigo-600/10 text-indigo-500 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-indigo-600 group-hover:text-white transition-colors">
                ...
                <h3 class="text-2xl font-black text-white mb-4 tracking-tight uppercase">Clinical & EMR</h3>
                ...
                <a href="/login" class="inline-flex items-center text-indigo-500 font-black text-[10px] uppercase tracking-widest group-hover:text-white transition-all">
                    Access Module &rarr;
                </a>
            </div>
            ...
            <div class="feature-card rounded-[3rem] p-10 group fade-up" style="transition-delay: 100ms">
                ...
                <h3 class="text-2xl font-black text-white mb-4 tracking-tight uppercase">Laboratory Ops</h3>
                ...
                <a href="/login" class="inline-flex items-center text-emerald-500 font-black text-[10px] uppercase tracking-widest group-hover:text-white transition-all">
                    Access Module &rarr;
                </a>
            </div>
            ...
            <div class="feature-card rounded-[3rem] p-10 group fade-up" style="transition-delay: 200ms">
                ...
                <h3 class="text-2xl font-black text-white mb-4 tracking-tight uppercase">Pharmacy & POS</h3>
                ...
                <a href="/login" class="inline-flex items-center text-purple-500 font-black text-[10px] uppercase tracking-widest group-hover:text-white transition-all">
                    Access Module &rarr;
                </a>
            </div>
...
<!-- Governance Focus -->
<section class="py-32 bg-indigo-600/5 relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="text-center mb-20">
            <h2 class="text-[11px] font-black text-indigo-500 uppercase tracking-[0.3em] mb-4">Institutional Integrity</h2>
            <h3 class="text-4xl md:text-6xl font-black text-white mb-6 uppercase tracking-tighter">Governance Protocol</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-16">
            <div class="fade-up">
                <div class="text-5xl font-black text-white/10 mb-4 italic">34+</div>
                <h4 class="text-xl font-black text-white mb-4 uppercase tracking-tight">Clinical Roles</h4>
            ...
            <div class="fade-up" style="transition-delay: 100ms">
                <div class="text-5xl font-black text-white/10 mb-4 italic">217+</div>
                <h4 class="text-xl font-black text-white mb-4 uppercase tracking-tight">Authorities</h4>
            ...
            <div class="fade-up" style="transition-delay: 200ms">
                <div class="text-5xl font-black text-white/10 mb-4 italic">SoD</div>
                <h4 class="text-xl font-black text-white mb-4 uppercase tracking-tight">Duty Segregation</h4>
