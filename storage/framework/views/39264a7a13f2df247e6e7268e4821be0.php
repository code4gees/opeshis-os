...
<?php $__env->startSection('title', 'Our Mission — Clinical Sovereignty for Africa | Opeshis OS'); ?>
...
<div class="pt-32 pb-20 border-b border-white/5 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
        <h1 class="text-5xl md:text-8xl font-black text-white tracking-tighter mb-8 uppercase fade-up">
            Architecting <span class="text-indigo-500">Clinical Sovereignty</span>
        </h1>
...
<section class="py-24 bg-[#050505]">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start mb-40">
            <div class="fade-up">
                <h2 class="text-[11px] font-black text-indigo-500 uppercase tracking-[0.3em] mb-8">The Opeshis Genesis</h2>
                <h3 class="text-4xl md:text-6xl font-black text-white mb-10 tracking-tighter leading-tight uppercase">Beyond Simple Software. <span class="text-indigo-500">Operating System Level.</span></h3>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div class="feature-card p-10 rounded-[3rem] fade-up">
                    <h4 class="text-4xl font-black text-indigo-500 mb-4 tracking-tighter">22</h4>
                    <p class="text-[10px] font-black uppercase tracking-widest text-white/30 mb-2">Pillar Modules</p>
                ...
                <div class="feature-card p-10 rounded-[3rem] fade-up" style="transition-delay: 100ms">
                    <h4 class="text-4xl font-black text-emerald-500 mb-4 tracking-tighter">100%</h4>
                    <p class="text-[10px] font-black uppercase tracking-widest text-white/30 mb-2">Offline Uptime</p>
                ...
                <div class="feature-card p-10 rounded-[3rem] fade-up" style="transition-delay: 200ms">
                    <h4 class="text-4xl font-black text-indigo-400 mb-4 tracking-tighter">AES</h4>
                    <p class="text-[10px] font-black uppercase tracking-widest text-white/30 mb-2">Data Sovereignty</p>
                ...
                <div class="feature-card p-10 rounded-[3rem] fade-up" style="transition-delay: 300ms">
                    <h4 class="text-4xl font-black text-rose-500 mb-4 tracking-tighter">CDSS</h4>
                    <p class="text-[10px] font-black uppercase tracking-widest text-white/30 mb-2">Clinical Intel</p>
        ...
        <div class="bg-indigo-600/5 border border-white/5 rounded-[4rem] p-20 text-white relative overflow-hidden fade-up">
            <div class="relative z-10">
                <div class="max-w-3xl mb-16">
                    <h2 class="text-[11px] font-black text-indigo-500 uppercase tracking-[0.3em] mb-8">Our Standards</h2>
                    <h3 class="text-4xl md:text-5xl font-black mb-10 tracking-tighter uppercase">Engineering for Institutional Longevity</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-16">
                    <div>
                        <h4 class="font-black text-[11px] uppercase tracking-widest mb-4 text-indigo-400">Clinical Integrity</h4>
                    ...
                    <div>
                        <h4 class="font-black text-[11px] uppercase tracking-widest mb-4 text-indigo-400">Financial Security</h4>
                    ...
                    <div>
                        <h4 class="font-black text-[11px] uppercase tracking-widest mb-4 text-indigo-400">National Impact</h4>
