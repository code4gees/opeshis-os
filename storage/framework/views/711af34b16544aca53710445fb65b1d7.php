...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
 ...
 <td class="px-6 py-4">
 <div class="text-xs font-semibold text-sage uppercase tracking-tight"><?php echo e($case->referral_diagnosis); ?></div>
 <div class="text-[8px] font-bold text-slate-600 font-medium mt-1 ">Source: <?php echo e($case->referral_source); ?></div>
 </td>
 <td class="px-6 py-4">
 <div class="text-[12px] text-slate-400 line-clamp-2 uppercase tracking-tight" title="<?php echo e($case->goals); ?>">"<?php echo e($case->goals); ?>"</div>
 </td>
