...
<div class="space-y-8 pb-20">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            <h1 class="text-2xl font-black text-slate-200 uppercase tracking-tighter"><?php echo e($type); ?> Command Hub</h1>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="group hover:bg-indigo-500/[0.02] transition-colors">
                            ...
                            <td class="px-5 py-4">
                                <div class="text-[11px] font-bold text-slate-400 italic leading-relaxed uppercase tracking-tight line-clamp-2" title="<?php echo e($p->clinical_findings); ?>">"<?php echo e($p->clinical_findings); ?>"</div>
                            </td>
                            <td class="whitespace-nowrap px-5 py-4 text-center">
                                ...
                                ?>
                                <span class="px-3 py-1 rounded-lg border <?php echo e($procCls); ?> text-[8px] font-black uppercase tracking-widest italic">
                            ...
                            <td class="whitespace-nowrap px-5 py-4 text-right">
                                <div class="text-[10px] font-black text-slate-500 uppercase tracking-widest italic">
                                    ...
                                    <span class="block text-[9px] text-slate-600 mt-1"><?php echo e(\Carbon\Carbon::parse($p->created_at)->format('H:i')); ?></span>
                                </div>
                            </td>
                        </tr>
