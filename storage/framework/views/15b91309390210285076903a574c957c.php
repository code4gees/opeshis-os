...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['headers' => [], 'title' => null, 'icon' => null]));
...
foreach (array_filter((['headers' => [], 'title' => null, 'icon' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="flex flex-col gap-4">
    ...
    <div class="flex items-center justify-between px-2">
        <div class="flex items-center gap-2">
            ...
            <i class="fas <?php echo e($icon); ?> text-sage/50"></i>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <h2 class="text-xs font-black uppercase tracking-[0.25em] text-slate-400"><?php echo e($title); ?></h2>
        </div>
    ...
    <div class="overflow-hidden rounded-2xl border border-subtle bg-card/20 ">
        <div class="overflow-x-auto">
            <table <?php echo e($attributes->merge(['class' => 'min-w-full divide-y divide-white/5'])); ?>>
...
<?php /**PATH C:\laragon\www\opeshis\resources\views\components\data-table.blade.php ENDPATH**/ ?>