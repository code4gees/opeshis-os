...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.public-shell','data' => ['title' => ''.e($title).' | Opeshis Insights']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($title).' | Opeshis Insights']); ?>
...
<div class="pt-40 pb-20 border-b border-subtle relative overflow-hidden">
 ...
 <span class="bg-sage px-4 py-1.5 rounded-full text-white font-semibold uppercase text-[12px] tracking-wider"><?php echo e($category); ?></span>
 <span class="text-white/40 text-[12px] font-medium uppercase tracking-widest"><?php echo e($date); ?></span>
 </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\opeshis\resources\views\public\article.blade.php ENDPATH**/ ?>