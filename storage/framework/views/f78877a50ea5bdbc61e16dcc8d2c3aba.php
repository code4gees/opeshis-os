            ...
            <div class="bg-slate-800 rounded-xl p-8 border border-slate-700/60 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="settings[hospital_name]" value="<?php echo e($settings['hospital_name'] ?? 'Opeshis General Hospital'); ?>" required class="w-full bg-slate-900 border border-slate-700 rounded-lg px-4 py-3 text-sm text-slate-200 outline-none focus:ring-2 focus:ring-blue-600">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-slate-500 uppercase mb-2">Primary Email</label>
                        <input type="email" name="settings[hospital_email]" value="<?php echo e($settings['hospital_email'] ?? 'contact@opeshis.com'); ?>" required class="w-full bg-slate-900 border border-slate-700 rounded-lg px-4 py-3 text-sm text-slate-200 outline-none focus:ring-2 focus:ring-blue-600">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-slate-500 uppercase mb-2">Phone Number</label>
                        <input type="text" name="settings[hospital_phone]" value="<?php echo e($settings['hospital_phone'] ?? '+237 000 000 000'); ?>" required class="w-full bg-slate-900 border border-slate-700 rounded-lg px-4 py-3 text-sm text-slate-200 outline-none focus:ring-2 focus:ring-blue-600">
                    </div>
                </div>
            </div>
