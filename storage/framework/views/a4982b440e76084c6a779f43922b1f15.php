...
<?php $__env->startSection('title', 'Blood Bank Command — Opeshis OS'); ?>
...
<div class="space-y-8 animate-fade-in">
    ...
    <header class="flex justify-between items-center mb-10 pb-8 border-b border-white/10">
        ...
        <div class="flex gap-4">
            <a href="<?php echo e(route('bloodbank.donors')); ?>" class="px-8 py-4 bg-white/5 border border-white/10 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-white/10 transition-all">
                Donor Registry
            </a>
            <a href="<?php echo e(route('bloodbank.inventory')); ?>" class="px-8 py-4 bg-rose-600 text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-xl shadow-rose-600/20 hover:bg-rose-700 transition-all border border-rose-500/50">
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-8 mb-12">
        <div class="glass-panel rounded-[2.5rem] p-10 border border-white/10 shadow-xl bg-gradient-to-br from-white/5 to-transparent flex flex-col justify-center">
            ...
            <h3 class="text-4xl font-black text-white italic tracking-tighter"><?php echo e($stats['total_units']); ?> <span class="text-[10px] font-black text-slate-600 ml-1 uppercase">Units</span></h3>
        </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['A+', 'B+', 'O+', 'AB+']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <?php $count = $stock->where('blood_group', $group)->first()->total ?? 0; ?>
            <div class="glass-panel p-8 rounded-[2rem] border border-white/10 shadow-xl relative overflow-hidden group hover:border-rose-500/30 transition-all">
                <div class="absolute -right-2 -top-2 opacity-5 font-black text-6xl italic group-hover:opacity-10 transition-opacity"><?php echo e($group); ?></div>
                <p class="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-4 italic">Group <?php echo e($group); ?></p>
                <div class="flex items-end gap-3">
                    <h3 class="text-3xl font-black <?php echo e($count > 5 ? 'text-white' : 'text-rose-500 animate-pulse'); ?> tracking-tighter italic"><?php echo e($count); ?></h3>
                ...
                <div class="w-full h-1 bg-white/5 rounded-full mt-6 overflow-hidden">
                    <div class="h-full bg-rose-600 shadow-[0_0_8px_rgba(225,29,72,0.5)]" style="width: <?php echo e(min(100, $count * 10)); ?>%"></div>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\opeshis\resources\views\bloodbank\index.blade.php ENDPATH**/ ?>