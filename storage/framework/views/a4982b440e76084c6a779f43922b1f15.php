...
<div class="space-y-8 animate-fade-in">
 ...
 <a href="<?php echo e(route('bloodbank.donors')); ?>" class="px-8 py-4 bg-[#2a2e38] border border-subtle text-white rounded-xl font-semibold text-[12px] font-medium hover:bg-white/10 transition-all">
 Donor Registry
 </a>
 <a href="<?php echo e(route('bloodbank.inventory')); ?>" class="px-8 py-4 bg-rose-600 text-white rounded-xl font-semibold text-[12px] font-medium /20 hover:bg-rose-700 transition-all border border-rose-500/50">
 ...
 <h3 class="text-4xl font-semibold text-white tracking-tighter"><?php echo e($stats['total_units']); ?> <span class="text-[12px] font-semibold text-slate-600 ml-1 uppercase">Units</span></h3>
 </div>
 ...
 <div class="absolute -right-2 -top-2 opacity-5 font-semibold text-6xl group-hover:opacity-10 transition-opacity"><?php echo e($group); ?></div>
 <p class="text-[12px] font-semibold text-slate-500 font-medium mb-4 ">Group <?php echo e($group); ?></p>
 <div class="flex items-end gap-3">
 <h3 class="text-3xl font-semibold <?php echo e($count > 5 ? 'text-white' : 'text-rose-500 animate-pulse'); ?> tracking-tighter "><?php echo e($count); ?></h3>
