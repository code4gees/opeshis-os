...
<div class="space-y-8 animate-fade-in">
 ...
 <div class="flex justify-between items-center p-5 bg-[#2a2e38] border border-subtle rounded-2xl hover:border-<?php echo e($isOk ? 'emerald' : 'rose'); ?>-500/30 transition-all group">
 <div>
 <h4 class="text-[12px] font-semibold text-white font-medium group-hover:text-sage transition-colors"><?php echo e($f['fridge_id']); ?></h4>
 <p class="text-[8px] text-slate-500 font-semibold uppercase mt-1">Last Sync: <?php echo e(date('H:i', strtotime($f['recorded_at']))); ?></p>
 </div>
 <div class="text-right">
 <div class="text-2xl font-semibold <?php echo e($isOk ? 'text-emerald-500' : 'text-rose-500 animate-pulse'); ?> leading-none">
 <?php echo e(number_format($f['temperature'], 1)); ?>°C
 </div>
 <span class="text-[7px] font-semibold <?php echo e($isOk ? 'text-emerald-600' : 'text-rose-600'); ?> font-medium"><?php echo e($isOk ? 'Optimal' : 'CRITICAL'); ?></span>
 </div>
 </div>
