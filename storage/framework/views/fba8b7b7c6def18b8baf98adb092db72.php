...
<?php $__env->startSection('title', 'Immunization Registry — Opeshis OS'); ?>
        ...
        <div class="xl:col-span-4 space-y-8">
            <div class="glass-panel rounded-[3rem] p-10 border border-white/10 shadow-xl relative overflow-hidden">
                ...
                <div class="space-y-4 relative z-10">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $fridges ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php $isOk = $f['temperature'] >= 2.0 && $f['temperature'] <= 8.0; ?>
                        <div class="flex justify-between items-center p-5 bg-white/5 border border-white/10 rounded-2xl hover:border-<?php echo e($isOk ? 'emerald' : 'rose'); ?>-500/30 transition-all group">
                            <div>
                                <h4 class="text-[11px] font-black text-white uppercase tracking-widest group-hover:text-indigo-400 transition-colors"><?php echo e($f['fridge_id']); ?></h4>
                                <p class="text-[8px] text-slate-500 font-black uppercase mt-1">Last Sync: <?php echo e(date('H:i', strtotime($f['recorded_at']))); ?></p>
                            </div>
                            <div class="text-right">
                                <div class="text-2xl font-black <?php echo e($isOk ? 'text-emerald-500' : 'text-rose-500 animate-pulse'); ?> italic leading-none">
                                    <?php echo e(number_format($f['temperature'], 1)); ?>°C
                                </div>
                                <span class="text-[7px] font-black <?php echo e($isOk ? 'text-emerald-600' : 'text-rose-600'); ?> uppercase tracking-widest"><?php echo e($isOk ? 'Optimal' : 'CRITICAL'); ?></span>
                            </div>
                        </div>
            ...
            <div class="grid grid-cols-2 gap-8">
                <div>
                    ...
                    <select id="adm_vaccine_id" class="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-sm font-black text-white outline-none focus:border-indigo-500/50 transition-all">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $vaccines ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\opeshis\resources\views\immunization.blade.php ENDPATH**/ ?>