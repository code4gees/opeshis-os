...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
 ...
 <div>
 <div class="font-semibold text-white text-sm uppercase group-hover:text-sage transition-colors"><?php echo e($h->household_head); ?></div>
 <div class="text-[8px] font-semibold text-slate-600 uppercase mt-0.5 ">Head of Household</div>
 </div>
 </div>
 </td>
 <td class="px-6 py-4">
 <div class="text-[12px] font-bold text-slate-400 uppercase tracking-tight "><?php echo e($h->location); ?></div>
 </td>
