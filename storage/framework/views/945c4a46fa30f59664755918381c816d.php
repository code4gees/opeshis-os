    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-slate-800 p-6 rounded-xl border border-slate-700/60 shadow-sm">
            ...
            <div class="flex items-end gap-2">
                <h3 class="text-4xl font-bold text-slate-100"><?php echo e(number_format($collectionEfficiency, 1)); ?>%</h3>
        ...
        <div class="bg-slate-800 p-6 rounded-xl border border-slate-700/60 shadow-sm">
            ...
            <div class="flex items-end gap-2">
                <h3 class="text-4xl font-bold text-blue-400"><?php echo e($avgWaitTime); ?>m</h3>
        ...
        <div class="bg-slate-800 p-6 rounded-xl border border-slate-700/60 shadow-sm">
            ...
            <h3 class="text-3xl font-bold text-slate-100"><?php echo e(number_format($totalCollected, 0)); ?></h3>
            <p class="text-[10px] text-slate-600 mt-2 font-medium">Billed: <?php echo e(number_format($totalBilled, 0)); ?></p>
        </div>
            ...
            <div class="space-y-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $morbidityPulse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="flex justify-between items-center p-3 bg-slate-900/40 rounded-lg border border-slate-700/40">
                        ...
                        <span class="text-xs font-bold text-blue-500"><?php echo e($m->count); ?> Cases</span>
                    </div>
            ...
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-slate-700/40">
                    ...
                    <tr class="hover:bg-slate-700/30 transition-colors">
                        <td class="px-8 py-5">
                            <div class="text-slate-100 font-bold uppercase text-xs"><?php echo e($item->item_name); ?></div>
                            <div class="text-[10px] text-slate-500 font-medium mt-1 uppercase">Asset ID: <?php echo e($item->id); ?></div>
                        </td>
