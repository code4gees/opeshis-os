...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
 ...
 <td class="px-6 py-4">
 <div class="font-semibold text-white text-sm uppercase group-hover:text-sage transition-colors"><?php echo e($c->claim_number); ?></div>
 <div class="text-[8px] font-bold text-slate-600 font-medium mt-1 ">Submission Protocol</div>
 </td>
 <td class="px-6 py-4">
 <div class="font-semibold text-white text-sm uppercase group-hover:text-sage transition-colors"><?php echo e($c->patient->full_name ?? 'UNKNOWN'); ?></div>
 <div class="text-[12px] text-slate-500 mt-1 uppercase"><?php echo e($c->patient->medical_id ?? 'N/A'); ?></div>
 </td>
 <td class="px-6 py-4">
 <div class="text-[12px] font-semibold text-slate-400 font-medium "><?php echo e($c->provider->name ?? 'UNKNOWN_PROVIDER'); ?></div>
 </td>
 <td class="px-6 py-4 text-center">
 <div class="text-sm font-semibold text-white tracking-tighter">XAF <?php echo e(number_format($c->total_claimed, 0)); ?></div>
 </td>
 <td class="px-6 py-4">
 <?php
...
<?php endif; ?>
 <div class="text-[8px] font-semibold text-slate-500 uppercase mt-1 tracking-wider"><?php echo e(strtoupper($c->status)); ?></div>
 </td>
