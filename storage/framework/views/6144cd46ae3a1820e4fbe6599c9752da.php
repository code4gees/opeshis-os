...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <form method="POST" action="<?php echo e(url('/clinical/eye/register')); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
        <div>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <form method="POST" action="<?php echo e(url('/clinical/eye/examination')); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <form method="POST" action="<?php echo e(url('/clinical/eye/refraction')); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <form method="POST" action="<?php echo e(url('/clinical/eye/surgery')); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
