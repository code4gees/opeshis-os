...
<div class="space-y-2">
    ...
    <div class="relative group">
        ...
        <select 
            ...
            id="<?php echo e($name); ?>" 
            <?php echo e($attributes->merge(['class' => ($icon ? 'pl-11' : 'px-4') . ' w-full bg-card/50 border border-subtle rounded-xl py-3 text-xs font-bold text-white outline-none focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/10 transition-all  appearance-none'])); ?>
