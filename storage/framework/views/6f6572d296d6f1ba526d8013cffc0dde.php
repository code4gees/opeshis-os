...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
 ...
 <div>
 <div class="font-semibold text-white text-sm uppercase group-hover:text-sage transition-colors"><?php echo e($encounter->patient->full_name); ?></div>
 <div class="text-[12px] font-bold text-slate-500 font-medium mt-0.5"><?php echo e($encounter->patient->medical_id); ?></div>
 </div>
 </div>
 </td>
 <td class="px-6 py-6">
 <div class="text-xs font-semibold text-slate-300 uppercase tracking-tight"><?php echo e($encounter->complaint); ?></div>
 <div class="text-[8px] font-bold text-slate-500 font-medium mt-1"><?php echo e($encounter->department); ?></div>
 </td>
 <td class="px-6 py-6">
 <span class="px-3 py-1 bg-[#2a2e38] text-slate-400 border border-subtle rounded-lg text-[12px] font-semibold font-medium "><?php echo e($encounter->visit_type); ?></span>
 </td>
...
<script>
 ...
 function openDischargeModal(id, name) {
  let url = "<?php echo e(route('clinical.opd.discharge', ':id')); ?>";
