...
<div class="space-y-8 animate-fade-in">
 ...
 <h3 class="text-[12px] font-semibold text-white font-medium"><?php echo e($ward->name); ?> <span class="text-slate-300 ml-2">(<?php echo e($ward->type); ?>)</span></h3>
 <span class="px-3 py-1 bg-card border border-subtle rounded-lg text-[8px] font-semibold uppercase text-slate-400"><?php echo e($ward->beds->where('status', 'Occupied')->count()); ?>/<?php echo e($ward->beds->count()); ?> Beds</span>
 </div>
 ...
 <div class="aspect-square rounded-2xl border <?php echo e($bed->status === 'Occupied' ? 'bg-sage border-indigo-600 text-white /20' : 'bg-[#2a2e38] border-subtle text-slate-300'); ?> flex flex-col items-center justify-center cursor-pointer group relative">
 <span class="text-[12px] font-semibold"><?php echo e($bed->bed_number); ?></span>
 ...
 <p class="text-[7px] font-semibold uppercase text-white truncate w-full"><?php echo e($bed->full_name); ?></p>
 <p class="text-[6px] font-semibold uppercase text-sage mt-1"><?php echo e($bed->medical_id); ?></p>
 </div>
 ...
 <td class="px-10 py-6">
 <div class="font-semibold text-white text-sm"><?php echo e($a->full_name); ?></div>
 <div class="text-[12px] text-slate-400 font-bold font-medium mt-1"><?php echo e($a->medical_id); ?></div>
 </td>
 <td class="px-10 py-6">
 <div class="text-[12px] font-semibold text-sage font-medium"><?php echo e($a->ward_name); ?></div>
 <div class="text-[12px] font-semibold text-slate-400 font-medium mt-1">Bed: <?php echo e($a->bed_number); ?></div>
 </td>
 <td class="px-10 py-6">
 <div class="text-[12px] text-slate-700 font-bold max-w-xs truncate"><?php echo e($a->diagnosis_at_admission); ?></div>
 <div class="text-[12px] text-slate-400 font-semibold uppercase mt-1"><?php echo e(\Carbon\Carbon::parse($a->admission_date)->diffForHumans()); ?></div>
 </td>
