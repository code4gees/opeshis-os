        ...
        <div class="flex gap-4">
            <div class="flex items-center gap-6 px-8 py-3 glass-panel rounded-2xl border border-white/5">
                <div class="text-center">
                    ...
                    <p class="text-xl font-black text-emerald-500 leading-none"><?php echo e($stats->active); ?></p>
                </div>
                <div class="w-px h-8 bg-white/10"></div>
                <div class="text-center">
                    <p class="text-[8px] font-black text-indigo-500 uppercase tracking-widest mb-1">Total Cycles</p>
                    <p class="text-xl font-black text-indigo-500 leading-none"><?php echo e($stats->total); ?></p>
                </div>
            </div>
                ...
                <div class="divide-y divide-white/5">
                    ...
                    <div class="px-10 py-6 group hover:bg-white/5 transition-all">
                        <div class="flex justify-between items-start mb-2">
                            <h4 class="text-sm font-black text-white uppercase"><?php echo e($cycle->name); ?></h4>
                            <span class="px-2 py-0.5 <?php echo e($cycle->status === 'active' ? 'bg-emerald-500/10 text-emerald-500 border-emerald-500/20' : 'bg-white/5 text-slate-500 border-white/10'); ?> rounded text-[8px] font-black uppercase border tracking-widest">
                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-white/5">
                            ...
                            <tr class="hover:bg-white/5 transition-all group">
                                <td class="px-10 py-6">
                                    <div class="font-black text-white text-sm uppercase group-hover:text-indigo-400 transition-colors"><?php echo e($r->staff_name); ?></div>
                                    <div class="text-[9px] font-bold text-slate-500 uppercase tracking-widest mt-0.5"><?php echo e($r->role); ?></div>
                                </td>
                                <td class="px-6 py-6 text-center">
                                    <div class="inline-flex items-center gap-1.5 px-3 py-1 bg-indigo-500/10 text-indigo-400 rounded-lg border border-indigo-500/20">
                                        <span class="text-xs font-black"><?php echo e($r->overall_rating); ?></span>
                                ...
                                <td class="px-6 py-6">
                                    <span class="text-[9px] font-black <?php echo e($r->status === 'signed' ? 'text-emerald-500' : 'text-amber-500'); ?> uppercase tracking-widest">
