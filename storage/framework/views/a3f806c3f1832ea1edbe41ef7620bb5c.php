...
<?php endif; ?>
    ...
    <div class="flex flex-wrap border-b border-slate-700/60 gap-8 px-2">
        ...
        <a href="<?php echo e(route('radiology', ['subtab' => $id])); ?>" class="pb-4 text-xs font-black uppercase tracking-widest border-b-2 transition-all <?php echo e($tab === $id ? 'text-blue-500 border-blue-500' : 'text-slate-500 border-transparent hover:text-slate-300'); ?>">
            <?php echo e($label); ?>
                        ...
                        <tr class="group hover:bg-blue-500/[0.02] transition-colors">
                            <td class="whitespace-nowrap px-5 py-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-bold text-slate-200 uppercase tracking-tight group-hover:text-blue-400 transition-colors"><?php echo e($o->full_name); ?></div>
                                        <div class="text-[10px] font-black text-slate-500 uppercase tracking-widest"><?php echo e($o->medical_id); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="whitespace-nowrap px-5 py-4">
                                <span class="px-2 py-0.5 bg-blue-500/10 text-blue-400 border border-blue-500/20 rounded text-[9px] font-black uppercase tracking-widest"><?php echo e($o->test_name); ?></span>
                                <div class="text-[10px] font-bold text-slate-500 uppercase mt-1"><?php echo e(date('d M, H:i', strtotime($o->ordered_at))); ?></div>
                            </td>
                            <td class="whitespace-nowrap px-5 py-4">
                                <div class="text-[10px] text-slate-400 italic max-w-[180px] truncate">"<?php echo e($o->indications ?? 'Routine assessment'); ?>"</div>
                                <div class="text-[9px] font-black text-slate-600 uppercase tracking-widest mt-1">Ref: Dr. <?php echo e($o->doctor_name); ?></div>
                            </td>
                ...
                <div class="space-y-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [
                        ...
                        <div class="flex justify-between items-center p-3 bg-slate-900/40 border border-slate-700/60 rounded-xl group hover:border-blue-500/30 transition-all">
                            <span class="text-[11px] font-black text-slate-300 uppercase tracking-tight"><?php echo e($name); ?></span>
                            <span class="text-[9px] font-black text-<?php echo e($color); ?>-500 uppercase tracking-widest"><?php echo e($status); ?></span>
                        </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
             <?php echo $__env->renderComponent(); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <form method="POST" action="<?php echo e(url('/radiology/action')); ?>" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="flex gap-3 pt-4">
            <?php if (isset($component)) { $__componentOriginal2d350f6afc4d732ce961fba75ba7e203 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2d350f6afc4d732ce961fba75ba7e203 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cc-button','data' => ['type' => 'submit','color' => 'blue','class' => 'w-full uppercase tracking-widest']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('cc-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','color' => 'blue','class' => 'w-full uppercase tracking-widest']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
