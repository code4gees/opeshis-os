    ...
    <div class="grid grid-cols-1 xl:grid-cols-12 gap-10">
        ...
        <div class="xl:col-span-8 space-y-8">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="px-3 py-1 bg-white/5 text-slate-400 rounded-lg text-[8px] font-black uppercase tracking-widest border border-white/10 italic">Ledger Sync: <?php echo e($incidents->count()); ?> Entries</span>
            </div>
                ...
                <div class="glass-panel rounded-[3rem] border border-white/10 shadow-xl p-10 hover:border-rose-500/30 transition-all relative group bg-white/[0.02]">
                    <div class="flex justify-between items-start mb-8">
                        <div class="flex flex-col gap-4">
                            ...
                            ?>
                            <span class="px-4 py-1.5 rounded-xl text-[8px] font-black uppercase tracking-[0.2em] border <?php echo e($sevCls); ?> w-max">
                                <?php echo e($i->severity_level); ?> SEVERITY
                            </span>
                            <h3 class="text-2xl font-black text-white uppercase tracking-tighter group-hover:text-rose-400 transition-colors"><?php echo e($i->incident_type); ?></h3>
                            <p class="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] italic"><?php echo e($i->location ?? 'UNSPECIFIED_INSTITUTIONAL_LOCATION'); ?> · <?php echo e(\Carbon\Carbon::parse($i->incident_date)->format('M j, Y · H:i')); ?></p>
                        </div>
                        <div class="text-right">
                            <span class="block text-[8px] font-black text-slate-600 uppercase tracking-[0.2em] mb-2 italic">Tracking Vector</span>
                            <span class="px-3 py-1 bg-white/5 text-indigo-400 rounded-lg text-[9px] font-black uppercase tracking-widest border border-white/10"><?php echo e($i->status); ?></span>
                        </div>
                    </div>
                    
                    <div class="p-8 bg-white/5 rounded-[2.5rem] border border-white/5 mb-10">
                        <p class="text-slate-300 text-[13px] font-bold leading-relaxed italic uppercase tracking-tight">"<?php echo e($i->description); ?>"</p>
                    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="glass-panel rounded-[3rem] p-10 border border-white/10 shadow-xl relative overflow-hidden bg-slate-900 group hover:border-indigo-500/30 transition-all">
                    <div class="flex justify-between items-start mb-8 relative z-10">
                        <span class="text-[9px] font-black text-rose-500 uppercase tracking-[0.2em] italic"><?php echo e($c->incident_type); ?></span>
                        <span class="px-2 py-1 bg-white/10 text-white rounded text-[7px] font-black uppercase tracking-widest border border-white/10"><?php echo e($c->status); ?></span>
                    </div>
                    <div class="p-6 bg-white/5 rounded-[2rem] border border-white/5 mb-8 relative z-10">
                        <p class="text-[11px] font-bold text-slate-300 leading-relaxed uppercase tracking-tight italic"><?php echo e($c->corrective_action); ?></p>
                    </div>
