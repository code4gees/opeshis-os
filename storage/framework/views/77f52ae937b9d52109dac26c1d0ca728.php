        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $alerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <div class="bg-slate-900/40 border border-rose-500/20 rounded-[2rem] p-8 relative overflow-hidden group shadow-2xl shadow-rose-900/10">
                ...
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <p class="text-[9px] font-black text-rose-500 uppercase tracking-[0.2em] italic"><?php echo e($a->alert_level); ?> ALERT_PROTOCOL</p>
                </div>
                <h3 class="text-xl font-black text-white mb-4 uppercase tracking-tighter italic">Outbreak Detected: <?php echo e($a->disease->disease_name); ?></h3>
                <p class="text-[11px] text-slate-400 leading-relaxed italic mb-8 uppercase tracking-tight">"<?php echo e($a->description); ?>"</p>
                <form method="POST" action="<?php echo e(url('/clinical/surveillance/resolve-alert/'.$a->id)); ?>">
                    <?php echo csrf_field(); ?>
                    <?php if (isset($component)) { $__componentOriginal2d350f6afc4d732ce961fba75ba7e203 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2d350f6afc4d732ce961fba75ba7e203 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cc-button','data' => ['type' => 'submit','color' => 'rose','variant' => 'ghost','class' => 'w-full uppercase tracking-widest text-[9px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('cc-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','color' => 'rose','variant' => 'ghost','class' => 'w-full uppercase tracking-widest text-[9px]']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $cases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr class="group hover:bg-rose-500/[0.02] transition-colors border-b border-slate-800/50 last:border-0">
                    <td class="px-5 py-6">
                        <div class="text-sm font-bold text-slate-200 uppercase tracking-tight group-hover:text-rose-400 transition-colors italic"><?php echo e($c->patient->full_name ?? 'SYSTEM_GEN_PROTOCOL'); ?></div>
                        <div class="text-[10px] font-black text-slate-500 uppercase tracking-widest mt-1"><?php echo e($c->patient->medical_id ?? 'NODE_UNKNOWN'); ?></div>
                    </td>
                    <td class="px-5 py-6">
                        ...
                        <div class="text-[8px] font-bold text-slate-600 uppercase tracking-widest mt-1"><?php echo e($c->disease->disease_name); ?></div>
                    </td>
                    <td class="px-5 py-6">
                        <div class="text-[10px] font-black text-slate-300 uppercase italic tracking-widest"><?php echo e(str_replace('_',' ', $c->outcome)); ?></div>
                    ...
                    <td class="px-5 py-6 text-center">
                        <div class="flex flex-col items-center">
                            <span class="text-lg font-black text-white italic leading-none"><?php echo e($c->contacts_count); ?></span>
