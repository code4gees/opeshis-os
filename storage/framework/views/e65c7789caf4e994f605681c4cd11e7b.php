...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $case): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr class="group hover:bg-indigo-500/[0.02] transition-colors">
                    ...
                    <td class="px-5 py-4">
                        <div class="text-[11px] font-black text-slate-300 uppercase tracking-tight truncate max-w-xs italic leading-tight">"<?php echo e($case->procedure_name); ?>"</div>
                    </td>
                    ...
                    <td class="whitespace-nowrap px-5 py-4">
                        <div class="text-[11px] font-black text-slate-200 italic tracking-tight"><?php echo e(\Carbon\Carbon::parse($case->scheduled_date)->format('H:i')); ?></div>
                        <div class="text-[9px] font-black text-slate-600 uppercase mt-1 italic"><?php echo e(\Carbon\Carbon::parse($case->scheduled_date)->format('d M Y')); ?></div>
                    </td>
                    <td class="whitespace-nowrap px-5 py-4 text-center">
                        <?php
                            $statusClasses = [
                        ...
                        ?>
                        <span class="px-3 py-1 rounded-lg border <?php echo e($cls); ?> text-[8px] font-black uppercase tracking-widest italic">
