...
<div class="space-y-8 animate-fade-in pb-20">
 ...
 <h3 class="text-4xl font-semibold text-white tracking-tighter"><?php echo e($enrollments->count()); ?> <span class="text-xs font-semibold text-sage ml-1 uppercase">Lives</span></h3>
 ...
 <h3 class="text-4xl font-semibold text-amber-500 tracking-tighter"><?php echo e($recentClaims->where('claim_status', 'pending')->count()); ?></h3>
 </div>
 ...
 <td class="px-10 py-6">
 <div class="font-semibold text-white text-sm uppercase group-hover:text-sage transition-colors"><?php echo e($e->full_name); ?></div>
 <div class="text-[12px] font-bold text-slate-500 font-medium mt-0.5 "><?php echo e($e->medical_id); ?></div>
 </td>
 <td class="px-6 py-6">
 <div class="text-[12px] font-semibold text-sage font-mono tracking-wider uppercase"><?php echo e($e->uhc_id); ?></div>
 <div class="text-[8px] font-bold text-slate-500 font-medium mt-1 ">Verified National Identifier</div>
 </td>
 <td class="px-6 py-6">
 <div class="text-[12px] font-semibold text-slate-400 font-medium"><?php echo e($e->scheme_name); ?></div>
 </td>
 ...
 <span class="text-[8px] font-semibold text-slate-500 font-medium">CLAIM_PROTOCOL_#<?php echo e($c->insurance_claim_id); ?></span>
 <span class="px-2 py-1 bg-amber-500/10 text-amber-500 rounded text-[7px] font-semibold font-medium animate-pulse border border-amber-500/20"><?php echo e($c->claim_status); ?></span>
 </div>
 <h5 class="text-[12px] font-semibold text-white uppercase tracking-tight group-hover:text-sage transition-colors"><?php echo e($c->full_name); ?></h5>
 <div class="mt-8 flex justify-between items-center">
 <span class="text-[12px] font-semibold text-white "><?php echo e(number_format($c->total_amount, 0)); ?> <span class="text-[8px] text-slate-500">FCFA</span></span>
