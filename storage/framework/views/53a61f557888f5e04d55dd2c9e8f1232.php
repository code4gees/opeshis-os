...
<?php $__env->startSection('title', 'UHC & Social Health Monitor — Opeshis OS'); ?>
...
<div class="space-y-8 animate-fade-in pb-20">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-4 gap-8 mb-10">
        <div class="glass-panel rounded-[2.5rem] p-10 border border-white/10 shadow-xl bg-gradient-to-br from-indigo-500/5 to-transparent flex flex-col justify-center relative overflow-hidden">
            ...
            <h3 class="text-4xl font-black text-white italic tracking-tighter"><?php echo e($enrollments->count()); ?> <span class="text-xs font-black text-indigo-500 ml-1 uppercase">Lives</span></h3>
        ...
        <div class="glass-panel rounded-[2.5rem] p-10 border border-white/10 shadow-xl bg-gradient-to-br from-amber-500/5 to-transparent flex flex-col justify-center">
            ...
            <h3 class="text-4xl font-black text-amber-500 italic tracking-tighter"><?php echo e($recentClaims->where('claim_status', 'pending')->count()); ?></h3>
        </div>
                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-white/5">
                        ...
                        <tr class="hover:bg-white/5 transition-all group">
                            <td class="px-10 py-6">
                                <div class="font-black text-white text-sm uppercase group-hover:text-indigo-400 transition-colors"><?php echo e($e->full_name); ?></div>
                                <div class="text-[9px] font-bold text-slate-500 uppercase tracking-widest mt-0.5 italic"><?php echo e($e->medical_id); ?></div>
                            </td>
                            <td class="px-6 py-6">
                                <div class="text-[11px] font-black text-indigo-400 font-mono tracking-widest uppercase"><?php echo e($e->uhc_id); ?></div>
                                <div class="text-[8px] font-bold text-slate-500 uppercase tracking-widest mt-1 italic">Verified National Identifier</div>
                            </td>
                            <td class="px-6 py-6">
                                <div class="text-[10px] font-black text-slate-400 uppercase tracking-widest"><?php echo e($e->scheme_name); ?></div>
                            </td>
        ...
        <div class="xl:col-span-4 space-y-8">
            <div class="glass-panel rounded-[3rem] p-10 border border-white/10 shadow-xl relative overflow-hidden bg-white/[0.02]">
                ...
                <div class="space-y-4 relative z-10">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recentClaims; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="p-8 rounded-[2.5rem] border border-white/5 bg-white/5 group hover:border-indigo-500/30 transition-all">
                        <div class="flex justify-between items-start mb-6">
                            <span class="text-[8px] font-black text-slate-500 uppercase tracking-[0.2em]">CLAIM_PROTOCOL_#<?php echo e($c->insurance_claim_id); ?></span>
                            <span class="px-2 py-1 bg-amber-500/10 text-amber-500 rounded text-[7px] font-black uppercase tracking-widest animate-pulse border border-amber-500/20"><?php echo e($c->claim_status); ?></span>
                        </div>
                        <h5 class="text-[12px] font-black text-white uppercase tracking-tight group-hover:text-indigo-400 transition-colors"><?php echo e($c->full_name); ?></h5>
                        <div class="mt-8 flex justify-between items-center">
                            <span class="text-[11px] font-black text-white italic"><?php echo e(number_format($c->total_amount, 0)); ?> <span class="text-[8px] text-slate-500">FCFA</span></span>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentClaims->isEmpty()): ?>
...
<div id="enrollModal" class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[100] hidden flex items-center justify-center p-8">
    <div class="glass-panel w-full max-w-xl rounded-[3rem] p-12 shadow-2xl border border-white/10">
        ...
        <form method="POST" action="<?php echo e(route('uhc.enroll')); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
            <div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\opeshis\resources\views\uhc\index.blade.php ENDPATH**/ ?>