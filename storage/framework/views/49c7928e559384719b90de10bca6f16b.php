...
<div <?php echo e($attributes->merge(['class' => 'cc-card group relative overflow-hidden rounded-xl border border-subtle bg-card/50 p-5  transition-all duration-300 hover:border-blue-500/30 hover: hover:/10'])); ?>>
    <!-- Decorative Glow -->
