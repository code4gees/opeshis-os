        ...
        <div class="flex items-center gap-6">
            ...
            <div>
                ...
                <div class="flex items-center gap-4 mt-2 text-[11px] font-bold uppercase tracking-wider">
                    <span class="text-blue-400"><?php echo e($encounter->medical_id); ?></span>
        ...
        <div class="lg:col-span-3 space-y-6">
            ...
            <div class="cc-card rounded-2xl border border-white/5 bg-slate-900/50 backdrop-blur-md overflow-hidden shadow-2xl">
                ...
                <div class="flex border-b border-white/5 bg-white/[0.02]">
                    ...
                    <button onclick="setSoapTab('<?php echo e($id); ?>')" id="btn-<?php echo e($id); ?>" class="tab-btn <?php echo e($id === 'subjective' ? 'active' : ''); ?> px-8 py-5 text-[11px] font-black uppercase tracking-[0.2em] transition-all border-b-2 border-transparent">
                        <?php echo e($label); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                                ...
                                <div id="prescList" class="space-y-3 mb-6">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $prescriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <div class="p-4 bg-white/[0.02] rounded-xl border border-white/5 flex justify-between items-center group hover:border-blue-500/30 transition-all">
                                            <div>
                                                <div class="text-[11px] text-slate-200 font-black uppercase tracking-tight"><?php echo e($p['drug']); ?></div>
                                                <div class="text-[9px] text-slate-500 font-bold uppercase mt-1"><?php echo e($p['dose']); ?></div>
                                            </div>
                                ...
                                <?php if (isset($component)) { $__componentOriginal2d350f6afc4d732ce961fba75ba7e203 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2d350f6afc4d732ce961fba75ba7e203 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cc-button','data' => ['type' => 'button','variant' => 'ghost','class' => 'w-full border-dashed border-white/10','onclick' => 'addPresc()','icon' => 'fa-plus']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('cc-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'ghost','class' => 'w-full border-dashed border-white/10','onclick' => 'addPresc()','icon' => 'fa-plus']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                ...
                <div class="space-y-6 relative">
                    ...
                    <div class="pl-8 relative">
                        ...
                        <p class="text-[10px] font-medium text-slate-500 mt-1">Started <?php echo e(\Carbon\Carbon::parse($encounter->created_at)->format('H:i')); ?></p>
                    </div>
