...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
 ...
 <div class="text-[12px] font-semibold text-slate-500 font-medium mt-1"><?php echo e($c->patient->medical_id); ?></div>
 </td>
 <td class="px-5 py-6">
 ...
 <div class="text-[12px] font-semibold text-slate-400 uppercase tracking-wider"><?php echo e(\Carbon\Carbon::parse($c->currentMethod->next_visit)->format("d M Y")); ?></div>
