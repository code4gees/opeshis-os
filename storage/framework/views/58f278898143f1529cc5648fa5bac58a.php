...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['title' => null, 'icon' => null, 'footer' => null]));
...
foreach (array_filter((['title' => null, 'icon' => null, 'footer' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div <?php echo e($attributes->merge(['class' => 'cc-card group relative overflow-hidden rounded-xl border border-white/5 bg-slate-900/50 p-5 backdrop-blur-md transition-all duration-300 hover:border-blue-500/30 hover:shadow-2xl hover:shadow-blue-500/10'])); ?>>
    <!-- Decorative Glow -->
...
<?php /**PATH C:\laragon\www\opeshis\resources\views\components\cc-card.blade.php ENDPATH**/ ?>