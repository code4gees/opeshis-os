...
<div class="space-y-8 animate-fade-in pb-20">
 ...
 <div>
 <h1 class="text-3xl font-semibold text-white tracking-tight uppercase">Fleet Command</h1>
 <p class="text-[12px] font-semibold text-slate-400 font-medium mt-1">Institutional Logistics · Ambulance Dispatch · Vehicle Telemetry Surveillance</p>
 </div>
 ...
 <h3 class="text-2xl font-semibold text-white uppercase tracking-tighter mb-4 ">Fleet Matrix Active</h3>
 <p class="text-slate-500 text-[12px] max-w-sm mx-auto font-semibold font-medium leading-relaxed ">The institutional logistics module is operational. Real-time vehicle telemetry will populate the matrix as units are dispatched.</p>
 </div>
 ...
 <h3 class="text-[12px] font-semibold text-sage font-medium mb-10 ">Logistics Integrity Pulse</h3>
 ...
 <span class="text-[12px] font-semibold text-slate-500 font-medium ">Unit Readiness:</span>
