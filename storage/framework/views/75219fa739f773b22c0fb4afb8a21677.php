...
<div class="max-w-7xl mx-auto space-y-8 animate-fade-in pb-20">
 ...
 <h3 class="text-3xl font-bold text-white"><?php echo e($activeQueue->where('status', 'waiting')->count()); ?> <span class="text-xs font-medium text-slate-500 ml-1">Patients</span></h3>
 </div>
 <div class="bg-[#2a2e38] p-6 rounded-xl border border-subtle ">
 <p class="text-[12px] font-bold text-emerald-500 font-medium mb-2">Ready for Doctor</p>
 <h3 class="text-3xl font-bold text-white"><?php echo e($activeQueue->where('status', 'awaiting_consultation')->count()); ?></h3>
 </div>
 <div class="bg-[#2a2e38] p-6 rounded-xl border border-subtle ">
 ...
 <td class="px-8 py-6">
 <div class="font-bold text-white uppercase text-xs"><?php echo e($q->full_name); ?></div>
 <div class="text-[12px] text-slate-500 font-bold font-medium mt-1">ID: <?php echo e($q->medical_id); ?> • <?php echo e($q->age); ?>Y • <?php echo e(strtoupper($q->gender)); ?></div>
 </td>
 <td class="px-6 py-6">
 <div class="text-xs font-bold text-sage uppercase tracking-tight"><?php echo e(str_replace('_', ' ', $q->intent ?? 'General Outpatient')); ?></div>
 <div class="text-[12px] text-slate-500 truncate max-w-xs mt-1">"<?php echo e($q->complaint['chief_complaint'] ?? 'No primary complaint recorded'); ?>"</div>
 </td>
 <td class="px-6 py-6">
 ...
 <span class="px-2 py-0.5 rounded text-[12px] font-bold uppercase border <?php echo e($isConsult ? 'bg-emerald-500/10 text-emerald-500 border-emerald-500/20' : 'bg-amber-500/10 text-amber-500 border-amber-500/20 animate-pulse'); ?>">
 <?php echo e(str_replace('_', ' ', $q->status)); ?>

 </span>
 </td>
 <td class="px-8 py-6 text-right">
 <button onclick="openVitalsModal('<?php echo e($q->id); ?>', '<?php echo e(addslashes($q->full_name)); ?>')" class="px-4 py-2 bg-sage hover:bg-sage text-white text-[12px] font-bold rounded-lg uppercase transition-all /10 border border-blue-500/50">Perform Triage</button>
 </td>
 </tr>
