...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
 ...
 <td class="px-5 py-6">
 <div class="text-sm font-bold text-slate-200 uppercase tracking-tight group-hover:text-sage transition-colors "><?php echo e($d->patient->full_name); ?></div>
 <div class="text-[12px] font-semibold text-slate-500 font-medium mt-1"><?php echo e($d->patient->medical_id); ?></div>
 </td>
 <td class="px-5 py-6">
 <div class="p-3 bg-card/50 rounded-xl border border-subtle ">
 <div class="text-[12px] text-sage font-semibold font-medium mb-1"><?php echo e($d->procedure_type); ?></div>
 <p class="text-[12px] text-slate-400 font-bold leading-relaxed uppercase tracking-tight line-clamp-2">"<?php echo e($d->indication); ?>"</p>
 </div>
 </td>
 <td class="px-5 py-6">
 ...
 ?>
 <span class="px-3 py-1 bg-<?php echo e($color); ?>-500/10 text-<?php echo e($color); ?>-400 border border-<?php echo e($color); ?>-500/20 rounded-lg text-[8px] font-semibold font-medium shadow-<?php echo e($color); ?>-500/5">
 <?php echo e($d->status); ?>
