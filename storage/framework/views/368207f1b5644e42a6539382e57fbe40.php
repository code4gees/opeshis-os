...
<div <?php echo e($attributes->merge(['class' => 'group relative overflow-hidden rounded-2xl border border-white/5 bg-slate-900/40 p-6 backdrop-blur-xl transition-all hover:border-indigo-500/30 hover:bg-slate-900/60'])); ?>>
    <!-- Ambient Glow -->
