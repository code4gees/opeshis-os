...
<div class="space-y-8 animate-fade-in">
 ...
 <h3 class="text-4xl font-semibold text-white tracking-tighter"><?php echo e($loadStats->total ?? 0); ?></h3>
 </div>
 ...
 <h3 class="text-4xl font-semibold text-emerald-500 tracking-tighter"><?php echo e($loadStats->passed ?? 0); ?></h3>
 </div>
 ...
 <h3 class="text-4xl font-semibold text-rose-500 tracking-tighter"><?php echo e($loadStats->failed ?? 0); ?></h3>
 </div>
 ...
 <h3 class="text-4xl font-semibold text-white tracking-tighter"><?php echo e($expiringCount); ?></h3>
 ...
 <td class="px-10 py-6">
 <div class="font-semibold text-sage text-sm uppercase group-hover:text-indigo-300 transition-colors"><?php echo e($l->load_number); ?></div>
 <div class="text-[12px] font-bold text-slate-500 font-medium mt-0.5 ">EXPIRY_SYNC: <?php echo e(\Carbon\Carbon::parse($l->expiry_date)->format('d M Y')); ?></div>
 </td>
 <td class="px-6 py-6">
 <div class="text-[12px] font-semibold text-white font-medium "><?php echo e($l->sterilizer_name); ?></div>
 </td>
 <td class="px-6 py-6">
 <div class="text-[12px] font-semibold text-slate-500 font-medium"><?php echo e($l->sterilization_method); ?></div>
 </td>
 ...
 <div class="p-6 rounded-3xl border <?php echo e($overdue ? 'border-rose-500/30 bg-rose-500/5 /5' : 'border-subtle bg-[#2a2e38]'); ?> transition-all group hover:border-indigo-500/30">
 <div class="flex justify-between items-start mb-4">
 <div>
 <h3 class="text-[12px] font-semibold text-white uppercase tracking-tight group-hover:text-sage transition-colors"><?php echo e($st->sterilizer_name); ?></h3>
 <p class="text-[8px] font-semibold text-slate-500 uppercase mt-1 tracking-wider"><?php echo e($st->sterilizer_type); ?></p>
 </div>
