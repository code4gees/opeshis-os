            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $census; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr class="group hover:bg-rose-500/[0.02] transition-colors">
                    ...
                    <td class="whitespace-nowrap px-6 py-4 text-center">
                        ...
                        <div class="text-[8px] font-black text-slate-600 uppercase mt-1"><?php echo e($c->source_unit ?? 'ORIGIN_NA'); ?></div>
                    </td>
                    <td class="whitespace-nowrap px-6 py-4">
                        <?php $v = $c->latestVital; ?>
                        <div class="flex gap-4">
                            <div class="text-center">
                                <div class="text-[10px] font-black text-slate-200"><?php echo e($v ? $v->bp_systolic.'/'.$v->bp_diastolic : '—'); ?></div>
                                <div class="text-[8px] font-bold text-slate-600 uppercase tracking-widest">BP</div>
                            </div>
                            <div class="text-center">
                                <div class="text-[10px] font-black <?php echo e(($v->spo2 ?? 100) < 90 ? 'text-rose-500 animate-pulse' : 'text-emerald-500'); ?>">
                                    <?php echo e($v ? $v->spo2.'%' : '—'); ?>
...
<?php endif; ?>
                            <div class="text-[10px] font-black text-slate-400 mt-1 uppercase tracking-widest">Score: <?php echo e($sofa); ?></div>
                        <?php else: ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <form method="POST" action="<?php echo e(url('/clinical/icu/admit')); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <form method="POST" action="<?php echo e(url('/clinical/icu/vitals')); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-3 gap-4">
            ...
            <div>
                ...
                <input name="<?php echo e($name); ?>" type="number" step="0.1" class="w-full bg-slate-900/50 border border-slate-700/60 rounded-xl px-4 py-2.5 text-xs font-black text-slate-200 outline-none">
            </div>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <form method="POST" action="<?php echo e(url('/clinical/icu/sofa')); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                <label class="block text-[9px] font-black text-slate-500 uppercase tracking-widest mb-2"><?php echo e($label); ?></label>
                <select name="<?php echo e($name); ?>" class="w-full bg-slate-900/50 border border-slate-700/60 rounded-xl px-4 py-2.5 text-xs font-black text-slate-200 outline-none">
