...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
 ...
 <td class="px-6 py-4">
 <div class="text-sm font-semibold text-white uppercase group-hover:text-sage transition-colors"><?php echo e($r->full_name); ?></div>
 <div class="text-[12px] font-bold text-slate-500 font-medium mt-1 "><?php echo e($r->medical_id); ?></div>
 </td>
 <td class="px-6 py-4">
 <div class="text-sm font-semibold <?php echo e(($r->cd4_count < 200) ? 'text-rose-500 animate-pulse' : 'text-emerald-500'); ?> tracking-tighter"><?php echo e($r->cd4_count ?? 'NULL'); ?></div>
 <div class="text-[8px] font-semibold text-slate-600 uppercase mt-0.5 ">Cells/mm³</div>
 </td>
 <td class="px-6 py-4">
 <div class="text-[12px] font-semibold text-sage uppercase tracking-wider"><?php echo e($r->viral_load ?? 'PENDING_SIGNAL'); ?></div>
 </td>
 <td class="px-6 py-4">
...
<?php endif; ?>
 <div class="text-[8px] font-semibold text-slate-400 uppercase mt-1 tracking-wider"><?php echo e($r->regimen ?? 'STANDARD_FIRST_LINE'); ?></div>
 </td>
