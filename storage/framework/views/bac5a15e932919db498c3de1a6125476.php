...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $census; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <tr class="group hover:bg-rose-500/[0.02] transition-colors border-b border-white/5 last:border-0">
                    <td class="px-6 py-4">
                        <div class="font-black text-white uppercase text-xs group-hover:text-rose-400 transition-colors italic"><?php echo e($c->patient->full_name); ?></div>
                        <div class="text-[10px] text-slate-500 mt-1 uppercase"><?php echo e($c->patient->medical_id); ?></div>
                    </td>
                    <td class="px-6 py-4 text-center">
                        <div class="text-[11px] font-black text-white bg-slate-900/50 py-1 px-3 rounded-lg border border-white/5 inline-block italic tracking-widest">G<?php echo e($c->gravida); ?> · P<?php echo e($c->parity); ?></div>
                    </td>
                    <td class="px-6 py-4 text-center">
                        <div class="text-[11px] font-black text-slate-400 uppercase italic tracking-widest"><?php echo e($c->gestational_age_weeks); ?> WEEKS</div>
                    </td>
                    <td class="px-6 py-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($latest): ?>
                            <div class="space-y-1">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-[10px] font-black <?php echo e($latest->fetal_heart_rate < 110 || $latest->fetal_heart_rate > 160 ? 'text-rose-500 animate-pulse' : 'text-emerald-500'); ?> italic">
                                        <?php echo e($latest->fetal_heart_rate); ?> BPM
                                    </span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <span class="text-[8px] font-black text-slate-600 uppercase italic">NODE:</span>
                                    <span class="text-[10px] font-black text-white italic"><?php echo e($latest->cervical_dilation_cm); ?> CM</span>
                                </div>
                            </div>
                        <?php else: ?>
                    ...
                    <td class="px-6 py-4">
                        ...
                        <div class="w-32">
                            <div class="flex justify-between items-center mb-1">
                                <span class="text-[8px] font-black text-slate-600 uppercase italic"><?php echo e($dil >= 10 ? 'STAGE_II' : 'STAGE_I'); ?></span>
                                <span class="text-[9px] font-black text-slate-300 italic"><?php echo e($dil); ?>/10CM</span>
                            </div>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <form method="POST" action="<?php echo e(url('/clinical/obstetrics/admit')); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
        <div>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <form method="POST" action="<?php echo e(url('/clinical/obstetrics/log-observation')); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <form method="POST" action="<?php echo e(url('/clinical/obstetrics/record-delivery')); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
