...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cc-button','data' => ['variant' => 'secondary','icon' => 'fa-history','href' => ''.e(route('clinical.dossier.show', $encounter->patient_id)).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'secondary','icon' => 'fa-history','href' => ''.e(route('clinical.dossier.show', $encounter->patient_id)).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<script>
 ...
 document.getElementById('soap-' + name).classList.remove('hidden');
  ...
  let icdCodes = <?php echo json_encode($icd10); ?>;
  let prescriptions = <?php echo json_encode($prescriptions); ?>;
...
<?php endif; ?>
<?php /**PATH /app/resources/views/emr.blade.php ENDPATH**/ ?>