    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="p-5 bg-slate-900/40 border border-white/5 rounded-2xl hover:border-indigo-500/30 transition-all group">
            ...
            <div class="flex items-baseline gap-2">
                <span class="text-2xl font-black text-white italic tracking-tighter"><?php echo e($latest->heart_rate ?? '--'); ?></span>
        ...
        <div class="p-5 bg-slate-900/40 border border-white/5 rounded-2xl hover:border-indigo-500/30 transition-all group">
            ...
            <div class="flex items-baseline gap-2">
                <span class="text-2xl font-black text-white italic tracking-tighter"><?php echo e($latest->spo2 ?? '--'); ?></span>
        ...
        <div class="p-5 bg-slate-900/40 border border-white/5 rounded-2xl hover:border-indigo-500/30 transition-all group">
            ...
            <div class="flex items-baseline gap-2">
                <span class="text-2xl font-black text-white italic tracking-tighter"><?php echo e($latest->temperature ?? '--'); ?></span>
        ...
        <div class="p-5 bg-slate-900/40 border border-white/5 rounded-2xl hover:border-indigo-500/30 transition-all group">
            ...
            <div class="flex items-baseline gap-2">
                <span class="text-2xl font-black text-white italic tracking-tighter"><?php echo e($latest->respiratory_rate ?? '--'); ?></span>
                <span class="text-[8px] font-black text-slate-600 uppercase">BPM</span>
            </div>
        </div>
    </div>
