...
<?php $__env->startSection('title', 'CREDENTIALING - Opeshis OS'); ?>

<div class="space-y-6 animate-fade-in">
    <div class="flex justify-between items-start border-b border-white/10 pb-8">
        <div>
            <h2 class="text-2xl font-black uppercase text-white tracking-tight">CREDENTIALING</h2>
    ...
    <div class="glass-panel rounded-[2.5rem] border border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.12)] overflow-hidden p-20 text-center">
        ...
        <h3 class="text-lg font-black text-white uppercase mb-2">CREDENTIALING Active</h3>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\opeshis\resources\views\admin\credentialing.blade.php ENDPATH**/ ?>