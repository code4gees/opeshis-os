...
class AnalyticsController extends Controller
{
    ...
    {
        $data = \Illuminate\Support\Facades\Cache::remember('analytics_intelligence', now()->addMinutes(10), function () {
            ...
            return compact(
                'collectionEfficiency', 'hourlyHeatmap', 'pharmacyVelocity',
                'morbidityPulse', 'supplyRisk', 'patientGrowth', 'avgWaitTime',
